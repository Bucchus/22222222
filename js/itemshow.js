...
//商品详情
    $.ajax({
        url:'http://192.168.18.132:8080/Shop/MobileFrontProductServlet?status=proDetail',
        dataType:'json',
        data:{"proNo":proNo,"uname":name},
        type:'post',
        success:function(result){
            ...
            addBox(result.allColor);
            addBox02(result.allSize);
            addBox03(result.product);
